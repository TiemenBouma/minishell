...
/*   Updated: 2022/08/18 14:27:32 by dkocob        ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
	...
	while (i < main_struct->cmd_count)
		{
			...
			if (id == 0)
			{
				...
				{
					exec_builtin(main_struct, &main_struct->cmd_struct_arr[i - 1], is_builtin(main_struct->cmd_struct_arr[i - 1].exec.exec_line[0]));
					exit(0);
				}
