...
/*   Updated: 2022/09/15 07:55:03 by tbouma           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// has_heredoc: %d\n", m_s->c_s_arr[i].has_infile, m_s->c_s_arr[i]
// .has_outfile, m_s->c_s_arr[i].has_appendfile, m_s->c_s_arr[i].has_heredoc);
// 		printf("fd_in = %d fd_out = %d\n", m_s->c_s_arr[i].fd_in,
// m_s->c_s_arr[i].fd_out);
