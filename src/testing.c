...
/*   Updated: 2022/08/16 08:23:55 by tbouma           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	print_cmd_info(struct s_main *main_struct)
{
	...
	while (i < main_struct->cmd_count)
	{
		printf("---------------------------------------\n");
		printf("CMDline_n %d\n", i);
		printf("has_in: %d has_out: %d has_appendfile: %d\n", main_struct->cmd_struct_arr[i].has_infile, main_struct->cmd_struct_arr[i].has_outfile, main_struct->cmd_struct_arr[i].has_appendfile);
